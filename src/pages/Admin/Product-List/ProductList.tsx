...
const ProductList = () => {
  ...
  return (
    <div className="w-auto mt-5">
      <h1 className="h2 ml-10 text-3xl font-bold">Quản Lý Sản Phẩm</h1>
      <div className="overflow-x-auto">
        <Link
          to="/admin/products/add"
          className="inline-block rounded bg-indigo-600 px-4 py-2 text-xs font-medium text-white hover:bg-indigo-700 ml-10 mt-4 float-right mr-20 mb-5"
        >
          Add Product
        </Link>
        <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
          <thead className="ltr:text-left rtl:text-right">
            <tr>
              ...
              <th className=" px-4 py-2 font-medium text-black">Price</th>
              ...
              <th className="px-4 py-2 font-medium text-black">Action</th>
            </tr>
          </thead>
